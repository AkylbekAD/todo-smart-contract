...
contract Todo {
    ...
    event NewTask(address user, string task_name, uint256 deadline);
    ...
    function addTask(
        ...
        uint256 inSeconds = hours_todo * 60 * 60;
    ...
    function showProductivity(address user_address) external view returns (uint256 productivityInPrecent) {
    ...
    function showTask(string memory task_name)
        external
        view
        returns (
            uint256 hours_todo,
